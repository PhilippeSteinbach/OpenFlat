...
namespace OpenFlat.Finance.Tests.Integration;

public class FinanceEndpointTests : IClassFixture<FinanceApiFactory>
{
    private readonly HttpClient _client;
    private readonly FinanceApiFactory _factory;

    public FinanceEndpointTests(FinanceApiFactory factory)
    {
        _factory = factory;
